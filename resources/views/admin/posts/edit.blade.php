    ...
    <div class="card">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-blod text-primary">
                {{$post->translate('title')}} ni o'zgartirish
            </h6>
        </div>
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.posts.update', $post->id) }}">
              ...
              @method('PUT')
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content_uz" id="" class="form-control summernote" cols="30" rows="10">{{$post->content_uz}}</textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content_ru" id="" class="form-control summernote" cols="30" rows="10">{{$post->content_ru}}</textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content_en" id="" class="form-control summernote" cols="30" rows="10">{{$post->content_en}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <img src="/storage/{{$post->img}}" width="200px" class="img img-thumbnail" alt="">
                    </div>
